"""
This module provides the function calling for only the `scider.core.exec` tool. This should be used only for Experiment Execution Agent.
"""
...
if TYPE_CHECKING:
    from scider.core.types import ExecState
