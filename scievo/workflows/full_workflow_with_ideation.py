"""
Full SciEvo Workflow with Ideation Agent
...
class FullWorkflowWithIdeation(BaseModel):
    ...
    def run(self) -> "FullWorkflowWithIdeation":
        ...
        logger.info("Starting Full SciEvo Workflow with Ideation")
        logger.info(get_separator())
...
"""
        ...
        return f"""# Full SciEvo Workflow with Ideation Summary
...
def run_full_workflow_with_ideation(
    ...
    """
    Convenience function to run the full SciEvo workflow with ideation.
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Full SciEvo Workflow with Ideation - Run ideation agent and optionally data/experiment workflows",
        prog="python -m scievo.workflows.full_workflow_with_ideation",
    )
