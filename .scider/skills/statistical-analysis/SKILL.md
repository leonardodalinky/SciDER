...
description: Guided statistical analysis with test selection, assumption checking, power analysis, and APA-formatted reporting. Use when choosing appropriate tests or formatting results for academic reporting.
allowed_agents: [data]
---
